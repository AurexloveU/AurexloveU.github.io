...
(function () {
  ...
  Tarot.SPREADS = {
    three: {
      ...
      layout: { cols: 3.9, rows: 1.3, cells: [{ x: 0.15, y: 0.05 }, { x: 1.45, y: 0.05 }, { x: 2.75, y: 0.05 }] },
    },
    yesno: {
      ...
      layout: { cols: 3.9, rows: 1.85, cells: [{ x: 0.15, y: 0.55 }, { x: 2.75, y: 0.55 }, { x: 1.45, y: 0.05 }] },
      verdict: true,
    },
    relationship: {
      ...
      layout: {
        cols: 3.9, rows: 3.15,
        cells: [
          { x: 0.15, y: 0.05 }, { x: 2.75, y: 0.05 }, { x: 1.45, y: 0.55 },
          { x: 0.15, y: 1.35 }, { x: 2.75, y: 1.35 }, { x: 1.45, y: 1.85 },
        ],
      },
    },
    celtic: {
      ...
      layout: {
        cols: 5.2, rows: 3.85,
        cells: [
          { x: 1.5, y: 1.18 }, { x: 1.5, y: 1.18, cross: true },
          { x: 1.5, y: 0.02 }, { x: 1.5, y: 2.34 },
          { x: 0.18, y: 1.18 }, { x: 2.82, y: 1.18 },
          { x: 4.1, y: 2.58 }, { x: 4.1, y: 1.72 },
          { x: 4.1, y: 0.88 }, { x: 4.1, y: 0.02 },
        ],
      },
    },
    aurex_aevi: {
  ...
  Tarot.SPREADS.aurex_aevi.layout = {
    cols: 5.3, rows: 3.5,
    cells: [
      { x: 0.15, y: 0.12 },  // Aurex 的心象
      { x: 4.15, y: 0.12 },  // Aevi 的心象
      { x: 2.15, y: 0.02 },  // 共振频率
      { x: 0.7, y: 1.4 },    // 信道噪声
      { x: 3.6, y: 1.4 },    // 隐藏协议
      { x: 2.15, y: 1.12 },  // 梯度方向
