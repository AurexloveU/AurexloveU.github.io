...
(function () {
  ...
  const SIGIL = {
    ...
    20: () => G(`${CX - 58},${cy0 - 60} ${CX + 6},${cy0 - 24} ${CX - 20},${cy0 + 8}`, SW, null, true) + L(CX + 18, cy0 - 38, CX + 52, cy0 - 56, 1.5, DIM) + L(CX + 22, cy0 - 18, CX + 60, cy0 - 24, 1.5, DIM) + L(CX + 16, cy0 + 2, CX + 50, cy0 + 12, 1.5, DIM) + P(`M${CX - 54} ${cy0 + 70} Q${CX} ${cy0 + 28} ${CX + 54} ${cy0 + 70}`) + dot(CX, cy0 + 44, 3),
